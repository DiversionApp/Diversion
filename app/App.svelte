<page actionBarHidden="{true}">
    <gridLayout columns="*, 3.8*, 3.8*, 3.8*, 0.5*" rows="*, 1.2*, *, 1.2*, 1.2*, 1.2*, 1.2*, 1.2*, 1.2*, 1.2*, 1.2*, 1.2*, *, 1.2*, *" backgroundColor="#242424">
        <image on:loaded="{onLoaded}" col="0" row="1" src="~/images/trakt-icon-red.png" stretch="aspectFit"/>
        <label col="0" row="2" text="Sign in" class="sign-in"/>
        <button on:loaded="{onLoaded}" col="0" row="3" text="&#xf002;" class="fas icons"/>
        <button on:loaded="{onLoaded}" col="0" row="4" text="&#xf015;" class="fas icons"/>
        <button on:loaded="{onLoaded}" col="0" row="5" text="&#xf008;" class="fas icons"/>
        <button on:loaded="{onLoaded}" col="0" row="6" text="&#xf26c;" class="fas icons"/>
        <button on:loaded="{onLoaded}" col="0" row="7" text="&#xf07c;" class="fas icons"/>
        <button on:loaded="{onLoaded}" col="0" row="13" text="&#xf013;" class="fas icons"/>
